...
function preload() {
  ...
  wendy = loadImage('assets/wendy.PNG');
...
function mostrarPuntos() {                  // La función mostrarPuntos, muestra
  ...
  if (puntos >= maxPuntos) {               // Si se llega a la cantidad máxima
    ...
    textSize(50);
    text("¡Genial, los estrellaste!", width / 2, height / 2);
    reinicio = true;
  }
}
